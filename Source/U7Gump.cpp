...
void Gump::Draw() {
    ...
    for (auto& item : thisObject->m_inventory) {
        ...
        DrawTextureEx(*object->m_shapeData->GetTexture(),
                      Vector2{m_Pos.x + xoffset, m_Pos.y + yoffset}, 0, 1,
                      Color{255, 255, 255, 255});
        xoffset += object->m_shapeData->GetTexture()->width + 2;
    }
}

void Gump::LinkContainer(int containerId) { m_containerId = containerId; }
