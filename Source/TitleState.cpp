	...
	DrawTexturePro(
		*m_title,
		...
		Rectangle{
			0,
			0,
			float(m_title->width * g_DrawScale * .5f),
...
void TitleState::CreateTitleGUI()
{
	...
	m_TitleGui->SetLayout(
		0, 0, g_Engine->m_RenderWidth, g_Engine->m_RenderHeight, g_DrawScale, Gui::GUIP_CENTER
	);
