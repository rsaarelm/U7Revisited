...
enum class ObjectTypes {
    OBJECT_STATIC = 0,  // Static objects cannot be changed.  They cannot be
                        // moved, created or destroyed.
    OBJECT_CREATURE,
    OBJECT_WEAPON,
    OBJECT_ARMOR,
    OBJECT_CONTAINER,
...
std::vector<std::shared_ptr<U7Object>> GetAllUnitsWithinRange(float x, float y,
                                                              float range);
...
void AddConsoleString(std::string string,
