...
bool IsMouseInRect(Rectangle rect)
{
	...
	return !IsMouseButtonDown(MOUSE_LEFT_BUTTON) && !IsMouseButtonDown(MOUSE_RIGHT_BUTTON) &&
		!IsMouseButtonDown(MOUSE_MIDDLE_BUTTON) && !IsMouseButtonPressed(MOUSE_LEFT_BUTTON) &&
		!IsMouseButtonPressed(MOUSE_RIGHT_BUTTON) && !IsMouseButtonPressed(MOUSE_MIDDLE_BUTTON) &&
...
void DrawStringCentered(
	Font* font, float fontsize, std::string text, float centerx, float centery, Color color
)
{
...
void DrawStringCentered(
	Font* font, float fontsize, char* text, float centerx, float centery, Color color
)
{
	DrawStringCentered(font, fontsize, text, Vector2{centerx, centery}, color);
}
...
void DrawStringRight(
	Font* font, float fontsize, std::string text, float rightx, float y, Color color
)
{
