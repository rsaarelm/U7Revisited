...
//  These functions only return true if the mouse is in the rectangle and no
//  mouse button is clicked or held.
...
void DrawStringCentered(Font* font, float fontsize, std::string text,
                        float centerx, float centery, Color color) {
